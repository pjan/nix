{ config, pkgs, ... }: {
  ...
  programs.fish.shellInit = ''
    source /run/current-system/etc/fish/conf.d/config.fish
    source /run/current-system/etc/fish/conf.d/functions/fish_greeting.fish
    source /run/current-system/etc/fish/conf.d/functions/fish_prompt.fish
    source /run/current-system/etc/fish/conf.d/functions/fish_right_prompt.fish
    source /run/current-system/etc/fish/conf.d/functions/fish_title.fish
  '';

  environment.etc."fish/conf.d/config.fish".text = ''
    # Configure the bobthefish theme
  ...
  environment.etc."fish/conf.d/functions/fish_greeting.fish".text = ''
  ...
  environment.etc."fish/conf.d/functions/fish_prompt.fish".text = ''
    # Managed by Nix. Don't edit.
    # Fish prompt from the bobthefish theme.
    #
    ...
    case 'solarized' 'solarized-dark'
      ...
      set __color_initial_segment_exit     $base1 $red --bold
      set __color_initial_segment_su       $base1 $green --bold
      set __color_initial_segment_jobs     $base1 $blue --bold
      ...
      set __color_repo                     $green $colorfg
      set __color_repo_work_tree           $base02 $colorfg --bold
      set __color_repo_dirty               $orange $colorfg
      set __color_repo_staged              $yellow $colorfg
      ...
      set __color_vagrant                  $violet $colorfg --bold
      set __color_k8s                      $green $colorfg --bold
      set __color_username                 $base03 $orange
      set __color_hostname                 $base03 $yellow
      set __color_rvm                      $red $colorfg --bold
      set __color_virtualfish              $cyan $colorfg --bold
      set __color_virtualgo                $cyan $colorfg --bold
  ...
  environment.etc."fish/conf.d/functions/fish_right_prompt.fish".text = ''
    # Managed by Nix. Don't edit.
    # Fish right prompt from the bobthefish theme.
    #
  ...
  environment.etc."fish/conf.d/functions/fish_title.fish".text = ''
    # Managed by Nix. Don't edit.
    # Fish title from the bobthefish theme.
    #
